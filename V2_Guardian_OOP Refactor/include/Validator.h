...
public:
    ...
    static bool hasAtSymbol(const std::string& email);
    ...
    static std::string getValidationErrors(const std::string& field,
        const std::string& value);

private:
	Validator() = delete; // Prevent instantiation - all methods are static
};